# OCI Cloud Bricks: Sample Django instance with File Sotorage System and postgreSQL Database
...
## Introduction
The following system builds a Sample linux compute with a File Storage System and a postgreSQL Database with the following reference architecture. Please note that a pre-set mount target is expected for this example to work. 
