...
## Introduction
The following system builds multiple Django Sample linux computes with a File Storage System, Load Balancer and a mySQL Database with the following reference architecture. Please note that a pre-set mount target is expected for this example to work. 
