...
![Reference Architecture](./images/Bricks_Architectures-lz_HUB_PRD_QA_HOM_DEV_SBX.jpg)
...
sbx01_compartment_name        = "SBX01_01"
...
sbx01_artifacts_compartment_name        = "SBX01_ARTIFACTS_01"
...
sbx01_network_compartment_name        = "SBX01_NETWORK_01"
...
1. Create Compartment System
   - Run: `./provisionInfra.sh CLI/landing_zones/lz_HUB_PRD_QA_HOM_DEV_SBX/network_system/`
   - A dialog as follows will appear: 

```shell
[opc@dalquintdevhubscl terraform-oci-cloudbricks-examples]$ ./provisionInfra.sh CLI/landing_zones/lz_HUB_PRD_QA_HOM_DEV_SBX/compartment_system/
...
```shell
[opc@dalquintdevhubscl terraform-oci-cloudbricks-examples]$ ./provisionInfra.sh CLI/landing_zones/lz_HUB_PRD_QA_HOM_DEV_SBX/network_system/
Sourcing environment variables
**************************************************************************  WARNING  *********************************************************************************
*   The following script will provision infrastructure. Type 'yes' and hit enter, if you want to continue. Neglecting something here may drop entire infrastructure  *
**************************************************************************  WARNING  *********************************************************************************
...
| <a name="module_hom01_network"></a> [hom01\_network](#module\_hom01\_network) | git::ssh://git@github.com/oracle-devrel/terraform-oci-cloudbricks-network-artifacts.git | v2.0.1 |
...
| <a name="module_sbx01_network"></a> [sbx01\_network](#module\_sbx01\_network) | git::ssh://git@github.com/oracle-devrel/terraform-oci-cloudbricks-network-artifacts.git | v2.0.1 |
