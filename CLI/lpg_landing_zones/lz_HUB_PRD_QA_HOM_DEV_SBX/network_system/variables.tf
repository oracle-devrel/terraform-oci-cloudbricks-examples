...
variable "sbx01_network_lpg_display_name_base" {
  description = "Local Peering Gateway Display Name Base"
}

variable "sbx01_network_peered_vcn_network_compartment_name" {
  description = "Compartment name of origin VCN to peer"
  default     = ""
}

variable "sbx01_network_peered_lpg_display_name" {
  description = "Display name of peered network"
  default     = ""
}

variable "sbx01_network_lpg_count" {
  description = "Number of LPG to create"
  default     = 1
