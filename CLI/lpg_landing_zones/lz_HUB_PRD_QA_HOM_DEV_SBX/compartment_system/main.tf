...
module "sbx01" {
  ...
  ######################################## COMPARTMENT SPECIFIC VARIABLES ######################################
  parent_compartment_name = module.mainbizcomp.compartment.name
  compartment_name        = var.sbx01_compartment_name
  compartment_description = var.sbx01_compartment_description
  enable_delete           = var.sbx01_enable_delete
  ######################################## COMPARTMENT SPECIFIC VARIABLES ######################################

}

module "sbx01_artifacts" {
  providers = {
    oci.home = oci.home
  }
  source     = "git::ssh://git@github.com/oracle-devrel/terraform-oci-cloudbricks-compartment.git?ref=v1.0.1"
  depends_on = [module.sbx01]
  ######################################## PROVIDER SPECIFIC VARIABLES ######################################
  tenancy_ocid     = var.tenancy_ocid
  region           = var.region
  user_ocid        = var.user_ocid
  ...
  ######################################## PROVIDER SPECIFIC VARIABLES ######################################
  ######################################## ARTIFACT SPECIFIC VARIABLES ######################################
  parent_compartment_name = module.sbx01.compartment.name
  compartment_name        = var.sbx01_artifacts_compartment_name
  compartment_description = var.sbx01_artifacts_compartment_description
  enable_delete           = var.sbx01_artifacts_enable_delete
  ######################################## ARTIFACT SPECIFIC VARIABLES ######################################
...
module "sbx01_network" {
  ...
  ######################################## ARTIFACT SPECIFIC VARIABLES ######################################
  parent_compartment_name = module.sbx01.compartment.name
  compartment_name        = var.sbx01_network_compartment_name
  compartment_description = var.sbx01_network_compartment_description
  enable_delete           = var.sbx01_network_enable_delete
  ######################################## ARTIFACT SPECIFIC VARIABLES ######################################
}