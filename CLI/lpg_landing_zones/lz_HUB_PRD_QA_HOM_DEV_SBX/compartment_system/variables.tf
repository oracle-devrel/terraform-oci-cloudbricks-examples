...
/********** sbx01 compartment **********/
variable "sbx01_compartment_name" {
  description = "Defines the display name of compartment"

}

variable "sbx01_compartment_description" {
  description = "Enters a description of the compartment"

}

variable "sbx01_enable_delete" {
  description = "Defines if this compartment can be programatically deleted by terraform destroy"
...
/********** ARTIFACT sbx01 compartment **********/
variable "sbx01_artifacts_compartment_name" {
  description = "Compartment Display Name"
}

variable "sbx01_artifacts_compartment_description" {
  description = "Compartment Description"
}

variable "sbx01_artifacts_enable_delete" {
  description = "Defines if this compartment can be programatically deleted by terraform destroy"
}
/********** ARTIFACT sbx01 compartment **********/

/********** NETWORK sbx01 compartment **********/
variable "sbx01_network_compartment_name" {
  description = "Compartment Display Name"
}

variable "sbx01_network_compartment_description" {
  description = "Compartment Description"
}

variable "sbx01_network_enable_delete" {
  description = "Defines if this compartment can be programatically deleted by terraform destroy"
}
/********** NETWORK sbx01 compartment **********/