# OCI Cloud Bricks: Sample OKE Cluster and Two Nodepools
...
| <a name="input_node02_node_pool_name"></a> [node02\_node\_pool\_name](#input\_node02\_node\_pool\_name) | Node Pool Name for K8 Cluster | `any` | n/a | yes |
