...
node01_node_pool_name                           = "my_node_pool1"
...
######################################## NODE02 SPECIFIC VARIABLES ########################################
node02_ssh_public_key                           = "/path/to/public/ssh/key/pub_key"
node02_ssh_private_key                          = "/path/to/public/ssh/key/priv_key"
node02_ssh_public_is_path                       = true
node02_ssh_private_is_path                      = true
node02_oke_cluster_compartment_name             = "MY_ARTIFACT_COMPARTMENT"
node02_oke_network_compartment_name             = "MY_NETWORK_COMPARTMENT"
node02_oke_availability_domain_map              = { "ad1" : "aBCD:foo-REGION-1-AD-1", "ad2" : "aBCD:foo-REGION-1-AD-2", "ad2" : "aBCD:foo-REGION-1-AD-3" }
node02_oke_cluster_name                         = "my_k8_cluster"
node02_oke_nodepool_network_subnet_name         = "node_pool_subnet"
node02_k8s_version                              = "K8_Version"
node02_node_pool_name                           = "my_node_pool2"
node02_node_pool_shape                          = "VM.Standard.A1.Flex"
node02_is_flex_shape                            = true
node02_nodepool_shape_config_ocpus              = 1
node02_nodepool_shape_config_memory_in_gbs      = 16
node02_number_of_nodes                          = 3
node02_k8s_label_map                            = { "SampleLabel1" : "SomeText", "SampleLabel1" : "AnotherText" }
######################################## NODE02 SPECIFIC VARIABLES ########################################
