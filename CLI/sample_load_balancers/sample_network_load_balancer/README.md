# OCI Cloud Bricks: Sample Network Load Balancer and Backend Set
...
## Introduction
The following system builds a Sample Network Load Balancer and Backend Set. The backend set can be populated with any number of custom computes.
