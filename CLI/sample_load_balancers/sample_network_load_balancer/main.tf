...
module "backendset01" {
  ...
  is_network_bes                             = var.backendset01_is_network_bes
  ...
  load_balancer_id                           = module.loadbalancer01.network_lbaas_instance[0].id
  lbaas_policy                               = var.backendset01_lbaas_policy
  balanced_artifact                          = module.compute01.instance
  backend_set_is_preserve_source             = var.backendset01_backend_set_is_preserve_source
  ######################################## ARTIFACT SPECIFIC VARIABLES ######################################
}
